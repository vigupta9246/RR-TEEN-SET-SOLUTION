...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',function(){
    ...
    if(last){var item=document.createElement('div');item.className='cinfo-item';item.innerHTML='<div class="cinfo-icon"><span class="icn icn-mobile"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M7 2h10a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1zm0 3v13h10V5H7zm5 14.5a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/></svg></span></div><div><div class="cinfo-label">Follow Us</div>'+mkIcons()+'</div>';last.after(item);}
  });
})();
